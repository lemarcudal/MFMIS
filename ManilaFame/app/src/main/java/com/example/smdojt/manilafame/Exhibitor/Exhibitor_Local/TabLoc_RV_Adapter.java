...
public class TabLoc_RV_Adapter extends RecyclerView.Adapter<TabLoc_RV_Adapter.ItemViewHolder> {
    ...
    List<Exhibitors_Loc> items;
    Context context;
    TabLoc_RV_Adapter(List<Exhibitors_Loc> items, Context context)
    {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fragment_exhibitor_tabloc_item, viewGroup, false);
